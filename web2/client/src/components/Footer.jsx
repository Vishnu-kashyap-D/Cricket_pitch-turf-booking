      ...
      <Container maxWidth="lg">
        <Grid container spacing={4}>
          <Grid item xs={12} sm={4}>
            ...
            <Typography variant="body2" sx={{ mb: 2 }}>
              Book your favorite cricket pitch with ease. We provide the best facilities
              and services for cricket enthusiasts.
            </Typography>
            <Box sx={{ mt: 2 }}>
        ...
        <Box sx={{ mt: 4, pt: 2, borderTop: '1px solid rgba(255, 255, 255, 0.1)' }}>
          <Typography variant="body2" align="center">
            © {new Date().getFullYear()} Cricket Booking System. All rights reserved.
          </Typography>
        </Box>
      </Container>
    </Box>
